-- {"id":1308639900,"ver":"1.1.5","libVer":"1.0.0","author":"Jobobby04"}
...
function defaults:parseNovel(novelURL, loadChapters)
	...
	if loadChapters then
		...
		for i = 1, lastChapterPage do
			local newChapters = self.selectChapters(
				GETDocument(self.baseURL .. "/e/extend/fy.php?page=" .. i .. "&wjm=" .. novelId),
				self.tableLength(chapters)
			)
